    ...
    public class InsureeController : Controller
    {
        ...
        public ActionResult Create([Bind(Include = "Id,FirstName,LastName,EmailAddress,DateOfBirth,CarYear,CarMake,CarModel,DUI,SpeedingTickets,CoverageType,Quote")] Insuree insuree)
        {
            if (ModelState.IsValid)
            {
                ...
                //  quote based on car's Manufactured Date
                ...
                // Adjust quote based on car model
                string carMakeLower = insuree.CarMake.ToLower();
                string carModelLower = insuree.CarModel.ToLower();

                if (carMakeLower == "Hyundai")
                {
                    baseQuote += 25m;
                    if (carModelLower == "Tuscan")
                    {
                        baseQuote += 25m;
                    }
                }

                //  charges for speeding tickets
                ...
                //  final quote (saving it to the object)
